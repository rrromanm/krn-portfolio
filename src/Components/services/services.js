        ...
        <div className='col-md-6'>
          ...
          <div className='row d-flex justify-content-center'>
            <div className='box col-md-4 text-start p-3'>
                <FontAwesomeIcon icon={faCameraRetro} size='2x' className='text-black float-left'/>
                <h6 className='fw-bold pt-3'>Capturing Moments</h6>
                <p>Immerse yourself in a world of memories with our photography services. From candid shots to striking portraits,
                    we freeze moments in time, ensuring every emotion and detail is beautifully preserved.
                </p>
            </div>
