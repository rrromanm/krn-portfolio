      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <p className="text-start">
            ...
            because every day I feel more confident in myself and my creativity.
          </p>
          ...
          <p className="text-start">
            ...
            for a family celebration, an outing, or other events. I believe that
            a photo report should convey emotions and capture those unique
            moments of joy.
            <br />I display all this in Our photographs, so that when years pass
            and you look at the report from the shooting again, those feelings
            and moments of happiness will return to you.
          </p>
        </div>
      </div>
    </div>
