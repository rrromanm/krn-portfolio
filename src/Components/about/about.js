    ...
    <div className='container mt-5'>
      <div className="row">
        ...
        <div className='col-md-6 py-5'>
          ...
          My name is Karina and I am an aspiring photographer and videographer in Spain. I hope to remove the beginner line soon, because every day I feel more confident in myself and my creativity.
          </p>
          ...
          <p className='text-start'>
          My style is clean and natural. <br></br>
          I am always looking for an original and individual vision, whether for a family celebration, an outing or other events. I believe that a photo report should convey emotions and capture those unique moments of joy. <br></br>
