...
const About = () => {
  ...
  const [isSmallerTablet, setIsSmallerTablet] = useState(window.innerWidth < 570)
  ...
  return (
    ...
    `}>
      <div className='row'>
        ...
        <div className='col-md-6'>
          <h1 className={`text-start ${isTablet || isSmallerTablet || isMobileM ? 'text-center' : ''}`}>ABOUT ME</h1>
